...
public class Test {
	...
	public static void main(String[] args) {
		...
		ImpressInstance impress = new ImpressInstance("ImpressJ", null, buttonAgents);
		...
		// dans sa boite provenant de B1. Il envoie a B1 le message REPONDRE et
		// crée un agent contexte ACI1_1
		// L'interface I2 = ImpressJ2 a une message de type ANNONCER dans sa
		// boite provenant de B1. Il envoie à B1 le message REPONDRE et crée un
		...
		// annonces.
		// version 2: L'interface I1 a un message de type ANNONCER provenant de
		...
		// actif.
		// Le bouton B1 a 2 messages de type REPONDRE dans sa boite provenant de
		...
		// boutonPred (B_1) et impress.getServiceAgentList().get(0) (I_1) sont
		// connectés et ne s'exécute pas
		// impress.getServiceAgentList().get(1) (I_2) ne s'exécute pas au cours
		...
		// impress.getServiceAgentList().get(1) (I_2) n'est pas exécuté pendant
		// ce cycle
		boutonSuiv.getServiceAgentList().get(0).nextStep();
